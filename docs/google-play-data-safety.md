...
| App activity: app interactions | The app maintains local settings such as theme, currency, backend URL, optional OpenAI key/model, AI category option, and scan status. | App functionality |
